...
export function CatalogTab({ products, onTap, onLongPress, onAddProduct, loading }) {
  ...
  const productExists = useMemo(() => {
    return search.trim() && products.some((p) => p.nome.toLowerCase() === search.trim().toLowerCase())
  }, [search, products])
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pt-4 pb-3 flex gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="search-bar w-full pl-10 pr-4 py-3 text-sm font-medium"
          />
        </div>
        <button
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        {loading ? (
          ...
          <>
            {/* Elite Shelf */}
            {eliteProducts.length > 0 && !search.trim() && activeCategory === ALL_CATEGORIES && (
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-base">⭐</span>
                  <h2 className="text-sm font-black italic uppercase tracking-wider" style={{ color: '#f59e0b' }}>
                    Prateleira de Elite
                  </h2>
                  <div
            ...
            {filteredProducts.length > 0 ? (
              ...
              !search.trim() && (
                <div className="text-center py-20">
                  ...
                  <p className="font-bold text-lg mb-2" style={{ color: '#64748b' }}>
